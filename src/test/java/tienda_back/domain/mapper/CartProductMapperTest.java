...
class CartProductMapperTest {
    ...
    void testCartProductRequestToCartProductDto_MapsCorrectly() {
        ...
        ProductRequest productRequest = new ProductRequest(20L, "Product", "Desc", 50.0, 10, new ArrayList<>());
    ...
    void testCartProductDtoToCartProductResponse_MapsCorrectly() {
        ...
        ProductDto productDto = new ProductDto(40L, "Product 2", "Desc 2", 75.0, 5, new ArrayList<>());
