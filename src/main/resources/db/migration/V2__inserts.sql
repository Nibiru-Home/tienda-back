...
INSERT INTO products (id, name, price, description, style, image, category_id) VALUES (1, 'Lampara techo', 30.00, 'Lampara de techo moderna en colores azul y marron', 'Moderno', '1.jpg', 1);
INSERT INTO products (id, name, price, description, style, image, category_id) VALUES (2, 'Armario vintage', 200.00, 'Armario de madera de estilo vintage', 'Vintage', '2.jpg', 2);
INSERT INTO products (id, name, price, description, style, image, category_id) VALUES (3, 'Cuadro Londres', 60.00, 'Cuadro de arte de Londres', 'Minimalista', '3.jpg', 3);
INSERT INTO products (id, name, price, description, style, image, category_id) VALUES (4, 'Manta algodón', 20.00, 'Manta de algodón colores marron y azul', 'Contemporaneo', '4.jpg', 4);
INSERT INTO products (id, name, price, description, style, image, category_id) VALUES (5, 'Cajonera anticuada', 25.00, 'Cajonera de madera anticuada', 'Anticuado', '5.jpg', 5);
